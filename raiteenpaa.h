...
public:
    ...
    enum Opaste { Pimea, Seis, Aja, AjaSn, AjaVarovasti, EiOpastetta, Tyhja, SeisLevy, NopeusRajoitus, OdotaLahtolupaa, Lahtolupa, OpastinPuuttuu, AjaVaratulle, VarattuRaide };
